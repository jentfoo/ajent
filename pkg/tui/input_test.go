...
func TestDecodeKey(t *testing.T) {
	...
	tests := []struct {
		...
		{"shift_arrow_up_moves", "\x1b[1;2A", key{typ: keyUp}, 6},
		{"shift_arrow_right_mode", "\x1b[1;2C", key{typ: keyShiftRight}, 6},
		{"shift_arrow_left_mode", "\x1b[1;2D", key{typ: keyShiftLeft}, 6},
