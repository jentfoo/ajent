...
const (
	...
	// cursorQuery asks the terminal where the cursor actually is (CSI row;col R).
	// A reflow that overflowed the screen clamps the park to the top row, and
	// only the terminal knows that happened.
	cursorQuery = csi + "6n"
