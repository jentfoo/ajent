...
// TestSinkFanoutForwardsToEveryMember asserts two sinks each receive the full
// event sequence, in registration order.
func TestSinkFanoutForwardsToEveryMember(t *testing.T) {
	t.Parallel()
...
// TestSinkFanoutToolDoneCallsEveryClosure asserts the ToolStart done closure
// reaches every member even when a member returns its own per-call closure.
func TestSinkFanoutToolDoneCallsEveryClosure(t *testing.T) {
	t.Parallel()
...
// TestOnSettledFiresWhenDrained asserts the settled observer runs once after
// the queues empty on a successful turn.
func TestOnSettledFiresWhenDrained(t *testing.T) {
	t.Parallel()
...
// TestOnSettledObserverCanQueueWork asserts an observer that queues another
// input keeps the same Prompt call alive until everything drains.
func TestOnSettledObserverCanQueueWork(t *testing.T) {
	t.Parallel()
...
// TestOnSettledObserverCanSteer asserts a settled observer that queues via Steer
// keeps the same Prompt call alive until everything drains.
func TestOnSettledObserverCanSteer(t *testing.T) {
	t.Parallel()
...
// TestOnSettledNotCalledOnErroredTurn asserts an errored turn never reports
// itself as settled.
func TestOnSettledNotCalledOnErroredTurn(t *testing.T) {
	t.Parallel()
