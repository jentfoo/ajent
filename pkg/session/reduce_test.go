...
func TestContextMessagesStampsOriginAcrossModelChange(t *testing.T) {
	t.Parallel()
...
func TestContextMessagesStampsOriginAcrossCompactionCut(t *testing.T) {
	t.Parallel()
...
func TestContextMessagesNilResolverLeavesUnstamped(t *testing.T) {
	t.Parallel()
